...
import { PromiseArray, PromiseObject, PromiseManyArray } from "ember-data/-private/system/promise-proxies";
import { Store } from "ember-data/-private/system/store";
import { Errors, RootState, attr } from "ember-data/-private/system/model";
...
import { AdapterError, InvalidError, UnauthorizedError, ForbiddenError, NotFoundError, ConflictError, ServerError, TimeoutError, AbortError, errorsHashToArray, errorsArrayToHash } from "ember-data/adapters/errors";
...
import { Transform, DateTransform, NumberTransform, StringTransform, BooleanTransform } from "ember-data/-private/transforms";
...
Object.defineProperty(global, 'DS', {
  configurable: true,
  get: function get() {
    deprecate('Using the global version of DS is deprecated. Please either import ' + 'the specific modules needed or `import DS from \'ember-data\';`.', false, { id: 'ember-data.global-ds', until: '3.0.0' });
