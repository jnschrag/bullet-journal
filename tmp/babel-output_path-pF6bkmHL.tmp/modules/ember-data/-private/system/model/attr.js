...
var AttrClassMethodsMixin = Ember.Mixin.create({
  /**
  ...
  */
  attributes: Ember.computed(function () {
    ...
    this.eachComputedProperty(function (name, meta) {
      if (meta.isAttribute) {
        assert("You may not set `id` as an attribute on your model. Please remove any lines that look like: `id: DS.attr('<type>')` from " + _this.toString(), name !== 'id');
...
export { AttrClassMethodsMixin };
var AttrInstanceMethodsMixin = Ember.Mixin.create({
  eachAttribute: function eachAttribute(callback, binding) {
    this.constructor.eachAttribute(callback, binding);
  }
});
export { AttrInstanceMethodsMixin };